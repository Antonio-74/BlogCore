...
namespace BlogCore.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "The {0} debe ser al menos de {2} y maximo {1} de caracteres de longitud.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Validamos si el rol seleccionado es Admin y si no lo agregamos
                    if(rol == CNT.Admin)
                    {
